...
<body>
    ...
    <button class="btn btn-outline-primary" type="submit">Search</button>
        ...
        <a href="http://localhost/FK-Edusearch/module1/Admin/login.php" class="w3-bar-item w3-button w3-hover-grey w3-right" id="horizontolNav" onclick="logOutVal()">LOG OUT</a>
            <!-- Profile dropdown-->
