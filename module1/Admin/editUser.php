...
<!-- main -->
<div class="main">
    <h1 id="locationT">EDIT PROFILE</h1>
    <hr>
...
<tr>
    <th>
    <h1 style="text-align: center; font-family:Courier New;"><b>PROFILE</b></h1><br>
    </th>
</tr>
<tr>
    <td><b style="padding-left:10px">FULLNAME</b>
    <center><input type="text" name="fullName" value="<?php echo $fullName; ?>" required></center>
    </td>
</tr>
<tr>
    <td><b style="padding-left:10px">USERNAME</b>
    <center><input type="text" name="userName" value="<?php echo $userName; ?>" required></center>
    </td>
</tr>
<tr>
    <td><b style="padding-left:10px">PHONE NUMBER</b>
    <center><input type="text" name="phoneNumber" pattern=".{10}" title="number phone should be 10 digits!." value="<?php echo $phoneNumber; ?>" required></center>
    </td>
</tr>
<tr>
    <td><b style="padding-left:10px">ADDRESS</b>
    <center><input type="text" name="address" value="<?php echo $address; ?>" required></center>
    </td>
</tr>
<tr>
    <td><b style="padding-left:10px">EMAIL</b>
    <center><input type="email" name="email" id="email" value="<?php echo $email; ?>" required></center>
    </td>
</tr>
<tr>
