...
<div class="main">
    ...
    <hr>
    <h5>Search user by fullname</h5>

<form action="findSearch.php" method="POST">
      <center><input type="text" placeholder="fullname" name="search" class="search" style="width: 300px;"><button type="submit" class="submitSearch"
      ><i class="fa fa-search"></i></button></center>
    </form>
    <br>
...
<?php
$search = $_POST['search'];
$sql_query="Select * from user WHERE fullName LIKE '%$search%'";								
