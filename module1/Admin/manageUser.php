...
while ($row = mysqli_fetch_array($result)) {
  ...
  <body>
    ...
    <div class="w3-top">
      <div class="w3-bar w3-white w3-card" id="myNavbar">
        <a href="index.php" class="w3-button w3-wide w3-hover-grey text-decoration: none;"><img
  ...
  <!-- main -->
  <div class="main">
    <h1 id="locationT">MANAGE USER</h1>
    <hr>
    <br>
    <table class="uInfo" style="background-color: #CDAC79; letter-spacing: 0.5px;">
      <form method="post" action="insert.php">
        <tr class="uTr">
          ...
          <th class="uTh">ACTION</th>

        </tr>

        <?php

        $sql_query = "Select * from user order by userID";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <tr class="uTr">
            ...
            <td>
              <a href="editUser.php?userID=<?php echo $row['userID']; ?>" class="edit" title="Edit"
                data-toggle="tooltip"><i class="fa fa-edit"></i></a>
              <a href="deleteUser.php?userID=<?php echo $row['userID']; ?>" class="edit" title="Delete"
