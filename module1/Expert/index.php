...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
        ...
        <a href="" class="w3-bar-item w3-button w3-hover-grey w3-right" id="horizontolNav"><i class="fa fa-user-circle-o" style="font-size:23px"></i>EXPERT, <?php echo $row['userName']; ?></a>
      </div>
  </div>
</div>
<?php } ?>
...
<div class="sidebar">
  ...
  <a href="expertProfile.php?userID=<?php echo $_SESSION['userID']; ?>"><i class="fa fa-user"></i> Profile</a>
</div>  
